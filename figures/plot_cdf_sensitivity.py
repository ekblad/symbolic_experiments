...
def main():
	...
	data_disc = data[data.cluster == 3]
	data_over = data[data.cluster == 2]
	data_dom = data[data.cluster == 1]
	datas = [data_disc,data_over,data_dom]
	...
	zorders ={'Parsimonious Cluster':3,
				'Overfit Cluster':2,
				'Dominated Cluster':1
				}
	...
	plt.savefig('plot_cdf.pdf',format='pdf',bbox_inches='tight',dpi=600,transparent=True)
