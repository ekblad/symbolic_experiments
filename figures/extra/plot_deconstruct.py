...
def main():
	...
	local_path = os.path.join(dir_path,'baseline_deconstruct')
	if 'baseline_deconstruct' in os.listdir(dir_path):
		rmtree('baseline_deconstruct') # only turn on if need to do again
