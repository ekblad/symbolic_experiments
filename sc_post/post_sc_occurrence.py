# this script calculates occurrence percentages across inputs and functions.

# occurrence percentage: 
# number of occurrences of model component/sum of all occurrences of all model components
...
print(infn_df)
infn_df.to_csv('sc_occurrence_data.csv')
exit()
